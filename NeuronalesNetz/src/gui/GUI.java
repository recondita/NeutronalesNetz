					...
					.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_erstellen.createSequentialGroup()
							.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_erstellen.createSequentialGroup()
									.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
										.addComponent(lblGenomAuswhlen, GroupLayout.DEFAULT_SIZE, 599, Short.MAX_VALUE)
										.addComponent(genomZuErstellen, GroupLayout.DEFAULT_SIZE, 599, Short.MAX_VALUE))
									.addGap(6)
									.addComponent(btnGenomZuErstellen, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE))
								.addComponent(btnLadenZuErstellen, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
								.addGroup(gl_erstellen.createSequentialGroup()
									.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
									...
									.addGroup(gl_erstellen.createParallelGroup(Alignment.TRAILING)
										.addGroup(gl_erstellen.createSequentialGroup()
											.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
												.addComponent(transferFunktion, 0, 486, Short.MAX_VALUE)
												.addComponent(layerZuErstellen, GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE)
												.addGroup(gl_erstellen.createSequentialGroup()
													.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
														.addComponent(learningRateZuErstellen, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE)
														.addComponent(momentumZuErstellen, GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE))
													.addPreferredGap(ComponentPlacement.RELATED)))
											.addGap(0))
										.addGroup(gl_erstellen.createSequentialGroup()
											.addComponent(speicherortZuErstellen, GroupLayout.DEFAULT_SIZE, 453, Short.MAX_VALUE)
											.addPreferredGap(ComponentPlacement.RELATED)
						...
						.addGroup(gl_erstellen.createSequentialGroup()
							.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
								.addComponent(btnErstellenZuErstellen, GroupLayout.DEFAULT_SIZE, 632, Short.MAX_VALUE)
								.addGroup(gl_erstellen.createSequentialGroup()
									.addComponent(label_5)
									.addGap(76)
									.addComponent(speicherortZuAlsGenomSpeichern, GroupLayout.DEFAULT_SIZE, 453, Short.MAX_VALUE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(btnSpeicherortZuAlsGenomSpeichern, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE))
								.addComponent(btnAlsGenomSpeichern, GroupLayout.DEFAULT_SIZE, 632, Short.MAX_VALUE)
								.addGroup(gl_erstellen.createSequentialGroup()
									.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
										...
										.addGroup(gl_erstellen.createSequentialGroup()
											...
											.addGap(39)
											.addComponent(spielaufzeichnungZuErstellen, GroupLayout.DEFAULT_SIZE, 453, Short.MAX_VALUE)))
									.addPreferredGap(ComponentPlacement.RELATED)
								...
								.addGroup(gl_erstellen.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.RELATED)
									.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
										.addComponent(maxIterationsZuErstellen, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE)
										.addComponent(maxTrainingZuErstellen, GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE))))
							.addContainerGap())
						.addGroup(gl_erstellen.createSequentialGroup()
