					...
					.addGroup(gl_erstellen.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_erstellen.createSequentialGroup()
							.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_erstellen.createSequentialGroup()
									.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
										.addComponent(lblGenomAuswhlen, GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE)
										.addComponent(genomZuErstellen, GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE))
									.addGap(6)
								...
								.addGroup(gl_erstellen.createSequentialGroup()
									...
									.addGap(48)
									.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
										.addComponent(transferFunktion, 0, 206, Short.MAX_VALUE)
										.addComponent(layerZuErstellen, GroupLayout.DEFAULT_SIZE, 206, Short.MAX_VALUE)
										.addGroup(gl_erstellen.createSequentialGroup()
											.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
												.addComponent(learningRateZuErstellen, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 206, Short.MAX_VALUE)
												.addComponent(momentumZuErstellen, GroupLayout.DEFAULT_SIZE, 206, Short.MAX_VALUE))
											.addPreferredGap(ComponentPlacement.RELATED)))
									.addGap(0)))
							.addContainerGap())
						.addGroup(gl_erstellen.createSequentialGroup()
						...
						.addGroup(gl_erstellen.createSequentialGroup()
							...
							.addGap(76)
							.addComponent(speicherortZuErstellen, GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnSpeicherortZuErstellen, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE)
							.addContainerGap())
						.addGroup(gl_erstellen.createSequentialGroup()
							.addComponent(btnErstellenZuErstellen, GroupLayout.DEFAULT_SIZE, 352, Short.MAX_VALUE)
							.addContainerGap())
						.addGroup(gl_erstellen.createSequentialGroup()
						...
						.addGroup(gl_erstellen.createSequentialGroup()
							...
							.addGap(76)
							.addComponent(speicherortZuAlsGenomSpeichern, GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnSpeicherortZuAlsGenomSpeichern, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE)
							.addContainerGap())
						.addGroup(gl_erstellen.createSequentialGroup()
							.addComponent(btnAlsGenomSpeichern, GroupLayout.DEFAULT_SIZE, 352, Short.MAX_VALUE)
							.addContainerGap())
						.addGroup(gl_erstellen.createSequentialGroup()
						...
						.addGroup(gl_erstellen.createSequentialGroup()
							.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_erstellen.createSequentialGroup()
									...
									.addGap(39)
									.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
										.addComponent(maxIterationsZuErstellen, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 206, Short.MAX_VALUE)
										.addGroup(gl_erstellen.createSequentialGroup()
											.addComponent(spielaufzeichnungZuErstellen, GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE)
											.addGap(6)
								...
								.addGroup(gl_erstellen.createSequentialGroup()
									...
									.addGroup(gl_erstellen.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_erstellen.createSequentialGroup()
											.addComponent(maxTrainingZuErstellen, GroupLayout.DEFAULT_SIZE, 287, Short.MAX_VALUE)
											.addPreferredGap(ComponentPlacement.RELATED))
